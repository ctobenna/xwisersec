	...
	<?php
		...
		dynamic_sidebar( 'excellent_footer_options' );
			...
			<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
							<?php esc_html_e('Designed by:','excellent'); ?> <a title="<?php esc_attr_e( 'Theme Freesia', 'excellent' ); ?>" target="_blank" href="<?php echo esc_url( 'https://themefreesia.com' ); ?>"><?php esc_html_e('Theme Freesia','excellent');?></a> | 
							<?php esc_html_e('Powered by:','excellent'); ?> <a title="<?php esc_attr_e( 'WordPress', 'excellent' );?>" target="_blank" href="<?php echo esc_url( 'https://wordpress.org' );?>"><?php esc_html_e('WordPress','excellent'); ?></a>
						</div>
		<?php endif; ?>
